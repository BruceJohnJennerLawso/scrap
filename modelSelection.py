...
if(__name__ == "__main__"):
	...
	if(ableToFit):
		...
		if(currentChoice == 9):
			...
			if(trimodDist.getTestStatistic("K-S")[0] < (model.getTestStatistic("K-S")[0])):
				model = trimodDist
		if(currentChoice == 11):
		...
		if((currentChoice == 10)or(currentChoice == 12)):
			...
			if(bimodDist.getTestStatistic("K-S")[0] < (model.getTestStatistic("K-S")[0])):
				model = bimodDist
	else:
	...
	print "Initial model:"
	try:
		print initialModel.distributionDescription()
		##print initialModel.getTestStatistic("K-S")
	except AttributeError:
		for initMod in initialModel:
			print initMod.distributionDescription()
			##print initMod.getTestStatistic("K-S")		
