## imSurfer.py #################################################################
## apparently IMLeagues developers are new to the idea of permissions, so Im ###
## gonna crawl the playoff brackets, both to search for our missing data for ###
## playoffs spring & fall 2016, and to see the extent of what is actually ######
## accessible at other organizations via this breach ###########################
################################################################################
#!/usr/bin/env python
